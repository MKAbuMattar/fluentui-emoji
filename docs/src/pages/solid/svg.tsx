...
<img src="https://cdn.jsdelivr.net/npm/fluentui-system-icons@latest/solid/ICON_SVG_NAME.svg" />

<!-- OR -->

<!-- fluentui emoji / unpkg -->
<img src="https://unpkg.com/fluentui-emoji@latest/solid/ICON_SVG_NAME.svg" />
`;
