---
'@fluentui-emoji/svg': major
'@fluentui-emoji/react': major
'@fluentui-emoji/astro': major
---

Monorepo consolidation — the `fluentui-emoji` and `react-fluentui-emoji` packages
